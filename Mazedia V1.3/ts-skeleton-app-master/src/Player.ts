class Player {
    ...
    constructor(
        ...
        this.vragen = ['Je komt ergens een bericht tegen van je favoriete youtuber die een giveaway doet. Jij…', 'Als je iets download waarvan je niet weet wat het is kan dat schadelijk zijn', 'Je krijgt een reclame over een persoon die je laat zien hoe je veel munten in je spel kunt krijgen. Jij…', 'Je kunt een post/afbeelding makkelijk van het internet afhalen!', 'Iemand die je kent wilt je inloggegevens hebben om je een skin te geven, wat doe je?'];
        
        
        
        for (let i = 0; i < 5; i++) {
            this.coin.push(this.rand(2, 200, 22), this.rand(2, 200, 22))
        }
        
        // for (let i = 0; i < 1; i++) {
            //     this.coin.coin1.push(this.rand(2, 645, 22), this.rand(2, 645, 22))
            //     this.coin.coin2.push(this.rand(2, 645, 22), this.rand(2, 645, 22))
            //     this.coin.coin3.push(this.rand(2, 645, 22), this.rand(2, 645, 22))
            //     this.coin.coin4.push(this.rand(2, 645, 22), this.rand(2, 645, 22))
            //     this.coin.coin5.push(this.rand(2, 645, 22), this.rand(2, 645, 22))
        ...
        for (let i = 0; i < x.length; i++) {
            ...
            if (document.getElementById('question').innerHTML == 'Iemand die je kent wilt je inloggegevens hebben om je een skin te geven, wat doe je?') {
                ...
                if (this.keyboardListener.isKeyDown(KeyboardListener.KEY_1)) {
                    ...
                    document.getElementById('question').innerHTML = `Fout`
                    document.getElementById('answers').innerHTML = ``
                }
                if (this.keyboardListener.isKeyDown(KeyboardListener.KEY_2)) {
                    ...
                    document.getElementById('question').innerHTML = `Goed`
                    document.getElementById('answers').innerHTML = ``
            ...
            if (document.getElementById('question').innerHTML == 'Als je iets download waarvan je niet weet wat het is kan dat schadelijk zijn') {
                document.getElementById('answers').innerHTML =
                    `<h1>7: Waar</h1><br>
                    <h1>8: Niet waar</h1>`
